---
title: "Yocto 03: How to Handle Multiple Yocto Meta Layers with repo"
...
* How to configure Yocto build directory, or you could also read my link:{{< relref "yocto-01-how-to-setup-yocto-for-rpi.adoc" >}}#build-configuration[other article] that shortly talks about it
